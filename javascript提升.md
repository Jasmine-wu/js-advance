...
function Person(name, sex) {
      ...
      function Student(name, sex, age) {
        //借用构造函数Person，继承构造函数内部的属性和方法
        Person.call(this, name, sex); 
        this.age = age;
      }
			// 原型继承：继承原型上的属性和方法
      Student.prototype = Object.create(Person.prototype);
			// 当prototype被整个替换时，要修正constructor指向
...
```js
 function myNew(constructor, ...args) {
        ...
        // 2. 将构造函数内的this指向空对象,执行构造函数。这样任何构造函数内部的属性和方法都会绑定到新空对象上。
...
avaScript不允许在同一个作用域内有相同名称的函数声明。

当你尝试重新声明一个已经存在的函数名时，后者会覆盖前者。
...
输出的结果是：b的值是20，在输出c的时候，出现了ReferenceError错误。
...
![](https://p.ipic.vip/gjyffe.jpg)



第二步：`GC`进来判断对象B没有其他引用，可以回收，对象A和C依然为活跃对象.

![](https://p.ipic.vip/sqtglt.jpg)

第三步：将活跃对象A、C从From空间复制到To空间

![](https://p.ipic.vip/8fun11.jpg)



第四步：清空From空间的全部内存

![](https://p.ipic.vip/dejamo.jpg)

第五步：交换From空间和To空间

![](https://p.ipic.vip/n5ywaf.jpg)

第六步：在From空间中又新增了2个对象D、E

![](https://p.ipic.vip/7jwdrh.jpg)

第七步：下一轮`GC`进来发现对象D没有引用了，做标记

![](https://p.ipic.vip/r0urd1.jpg)

第八步：将活跃对象A、C、E从From空间复制到To空间

![](https://p.ipic.vip/r0bqnu.jpg)

第九步：清空From空间全部内存

![](https://p.ipic.vip/5e5grq.jpg)

第十步：继续交换From空间和To空间，开始下一轮

![](https://p.ipic.vip/bfb33z.jpg)
...
![](https://p.ipic.vip/gzr2z6.jpg)

![](https://p.ipic.vip/prhzhl.jpg)

![](https://p.ipic.vip/fpxqbi.jpg)
...
![](https://p.ipic.vip/i5ggfh.jpg)

![](https://p.ipic.vip/5alrvl.jpg)

![](https://p.ipic.vip/l17jh0.jpg)

![](https://p.ipic.vip/itb3z6.jpg)
